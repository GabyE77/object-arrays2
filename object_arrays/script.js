...
let differentColors = ['green','blue','red']
differentColors.push("Yellow");
differentColors.push(5);
differentColors.push({greeting: "hi, I am an object"});
const catBreeds = [{
    name: "Abyssinian",
...
console.log(differentColors[2]);
console.log(differentColors[5]);
console.log("breed cat 3:", catBreeds[2].name);
